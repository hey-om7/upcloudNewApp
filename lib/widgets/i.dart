    ...
    return AnimatedContainer(
      ...
      child: Form(
        child: Column(
          ...
          children: [
            SizedBox(height: 20),
            listItem_i('Drinking', '$drinkingValue', context),
            CustomDivider(),
            listItem_i('Smoking', '$smokingValue', context),
            CustomDivider(),
            listItem_i('Chewing Tobacco', '$tobaccoValue', context),
            CustomDivider(),
            listItem_i('Lifestyle', '$lifestyleValue', context),
            CustomDivider(),
            listItem_i('Food Preference', '$foodPreferenceValue', context),
            CustomDivider(),
